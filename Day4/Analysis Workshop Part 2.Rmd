...
#install.packages(c("broom","gt","correlation", "gtsummary", "report", "interactions", "naniar"))
...
tidied_whisky_data <- read_csv(url("https://raw.github.com/DCS-training/SummerSchoolStream2ContentTesting/main/Day1/DataWrangling/RMD_file_data/tidied_whisky_data.csv")) %>% 
  mutate(
