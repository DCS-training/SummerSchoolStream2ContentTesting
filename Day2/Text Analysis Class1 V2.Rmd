...
```{r Import the required packages, results='hide'}
...
Remove the stopwords in our corpus. Stopwords are a set of commonly used "filler" or modifying words in a language. Examples of stopwords in English are "a," "the," "is," "are," etc. Stopword removal is a common preprocessing task in natural language processing (NLP) that aims to improve the that are so widely used that they carry very little useful information.
