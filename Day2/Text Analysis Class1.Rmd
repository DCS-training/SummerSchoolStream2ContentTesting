...
This does not make much sense since we are looking at a fully textual dataset. The next thing we need to do is to create a corpus out of the text column (that contains the text of each parish report)
