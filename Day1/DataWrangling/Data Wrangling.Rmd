...
# Data Batch 1
scotch_reviews <- read_csv(url("https://raw.github.com/DCS-training/SummerSchoolStream2ContentTesting/main/Day1/DataWrangling/RMD_file_data/scotch_review_manual_clean.csv"))

List_of_whisky_distilleries_in_Scotland <- read_csv(url("https://raw.github.com/DCS-training/SummerSchoolStream2ContentTesting/main/Day1/DataWrangling/RMD_file_data/List_of_whisky_distilleries_in_Scotland_manual_clean.csv"))
...
summary_data <- df_merge %>% 
  mutate(Old_v_new = case_when(Founded <= 1900 ~ "Old Distilleries", #creating an infamous median split...
...
-   Saving your data.
-   Using data wrangling to summarise and present our data.
