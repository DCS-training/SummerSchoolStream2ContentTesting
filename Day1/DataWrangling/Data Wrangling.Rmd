...
# Data Batch 1
scotch_reviews <- read_csv("scotch_review_manual_clean.csv")
List_of_whisky_distilleries_in_Scotland <- read_csv("List_of_whisky_distilleries_in_Scotland_manual_clean.csv")
