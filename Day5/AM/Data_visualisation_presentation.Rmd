...
library(extrafont) #additional fonts - not relevant in noteable 
#loadfonts(device="win") - will not work in notable
library(tidyverse) # datat tidying
...
```{r fancyplot, echo = FALSE, warning = FALSE, message = FALSE}
#| fig-width: 16
#| fig-height: 8
fancy_plot <-  Whisky_data %>% 
...
ggplot(
  ...
  coord_flip()+
  scale_fill_manual(
    values = c(Speyside = "#576884", Lowland = "#BE8B5E", Highland = "#46415F", 
               Islay = "#8D4046", Island = "#8A5366", Campbeltown = "#395558" )) + 
  theme_bw() + 
  theme(strip.background = 
    element_rect(fill="#BAB8BD",
    color = "black",
    size =.8),
    text= element_text( 
    size=12, 
...
```{r ggplot_function, echo = TRUE,warning = FALSE, message = FALSE}
...
```{r data_layer, echo = TRUE, warning = FALSE}
#| code-line-numbers: "2"
#| output-location: column-fragment
#| fig-width: 10
#| fig-height: 6
...
```{r coordinates, echo = TRUE, warning = FALSE}
#| code-line-numbers: "3"
#| output-location: column-fragment
#| fig-width: 10
#| fig-height: 6
...
```{r geoms_2, echo = TRUE, warning = FALSE}
#| code-line-numbers: "5"
#| output-location: column-fragment
#| fig-width: 10
#| fig-height: 6
...
```{r geoms_3, echo = TRUE, warning = FALSE}
...
```{r scaled_geoms, echo = TRUE, warning = FALSE}
...
```{r scaled_geoms_2, echo = TRUE, warning = FALSE}
...
```{r taming_code, echo = TRUE, warning = FALSE}
...
```{r themes_and_color_schemes, echo = TRUE, warning = FALSE}
...
plot +
  scale_fill_manual(
    values = c(Speyside = "#576884", Lowland = "#BE8B5E", Highland = "#46415F", 
               Islay = "#8D4046", Island = "#8A5366", Campbeltown = "#395558" )) + #setting to discrete variables
  theme_bw() + # from ggthemes
  theme(strip.background = # play with facet label
    element_rect(fill="#BAB8BD",# facet label fill
...
```{r themes_and_color_schemes_font, echo = TRUE, warning = FALSE}
...
```{r lFont_change, echo = TRUE, warning = FALSE}
...
```{r labelled_plot, echo = TRUE, warning = FALSE}
...
```{r interactive_plot, echo = TRUE, warning = FALSE}
#| output-location: column-fragment
#| fig-width: 12
#| fig-height: 8
